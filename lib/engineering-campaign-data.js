...
export const ENGINEERING_TRACKED_FACTS = {
  'trade.markets-visited-distinct': {
    ...
    minimum:0,
    quickAdd:[1,3,5],
    description:'Count each distinct commodity market once. This can satisfy future Engineer unlock prerequisites without turning one later task into a 50-market wall.',
  },
  'trade.black-markets-used-distinct': {
    ...
    minimum:0,
    quickAdd:[1,2,3],
    description:'Count each distinct black market once. Only record what you actually used; repeat visits to the same black market do not increase this total.',
  },
};
