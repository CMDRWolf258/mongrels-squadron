...
async function requestOperationsDiscord(env,{method='POST',messageId='',payload={},wait=false}={}){
...
function normalizePayload({embeds=[],content='',username='Mongrel Mission Control'}={}){
  return {
