...
export function publicAccount(account) {
  ...
  return {
    ...
    lastSyncSource:account.lastSyncSource || '',
    lastAutoSyncAt:account.lastAutoSyncAt || null,
    lastAutoSyncAttemptAt:account.lastAutoSyncAttemptAt || null,
    lastAutoSyncError:account.lastAutoSyncError || '',
    autoSyncReauthRequired:Boolean(account.autoSyncReauthRequired),
