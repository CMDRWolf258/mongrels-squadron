...
export async function searchTradeMarkets(env,input,{fetchImpl=fetch,timeoutMs=15000}={}) {
  ...
  if(query.rareSourceSearch)warningParts.push('Rare-source search: radius and market-age cutoffs do not exclude the unique source; distance and freshness are still displayed from '+query.referenceSystem+'.');
