...
function normalizeRareAllocation(value){
  ...
  return{
    ...
    dayHighPrice:whole(source.dayHighPrice,0,2000000000,0),
    positiveReports:whole(source.positiveReports,0,1000,0),
    lastPositiveReportAt:iso(source.lastPositiveReportAt),
