      ...
      body: JSON.stringify({
        embeds: [{
          ...
          fields: [
            ...
            {
              name: 'In-Game Squadron Application — Also Required',
              value: 'In Elite Dangerous, open the **right-hand Internal Panel → Squadrons → Browse/Search**, search **Mongrels**, select **Regiment of Imperial Mongrels** (PC tag **[R1MM]**), and choose **Apply**. Leadership normally verifies this application before approval.',
            },
            {
            ...
            },
            {
              ...
              value: 'Leadership will review the website application and confirm the matching in-game Squadron application. You can return to the website to check your status.',
            },
          ],
    ...
    ready = await discordRequest(env, `/channels/${encodeURIComponent(channelId)}/messages`, {
      ...
      body: JSON.stringify({
        embeds: [{
          ...
          description: 'Selected Applicant? Complete the website application **and** submit an in-game Elite Dangerous Squadron application. Search **Mongrels** in the Squadrons panel and apply to **Regiment of Imperial Mongrels [R1MM]**.',
        }],
        components: [{
          type: 1,
          components: [{
