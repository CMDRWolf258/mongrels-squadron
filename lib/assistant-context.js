...
function pickModules(query) {
  ...
  if (has('bgs','background simulation','influence','inf','tick','minor faction','expansion','retreat','war','civil war','election','boom','bust','civil liberty','civil unrest','lockdown','outbreak','famine','public holiday','pirate attack','asset ownership','controlling faction','invasion')) set.add('knowledge');
...
function relatedLinks(modules, query = '') {
  ...
  if (modules.has('knowledge')) { add('Field Manual', '/guides/'); if (hasBgsTerms(query)) add('BGS Guide', '/guides/bgs/'); }
...
function hasBgsTerms(query) {
  ...
  return ['bgs','background simulation','influence','inf','tick','minor faction','expansion','retreat','war','civil war','election','boom','bust','civil liberty','civil unrest','lockdown','outbreak','famine','public holiday','pirate attack','asset ownership','controlling faction','invasion'].some(x => q.includes(x));
}
