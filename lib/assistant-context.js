...
function pickModules(query) {
  ...
  if (has('engineering','engineer','experimental','corrosive','incendiary','auto loader','oversized','feedback','drag munitions','shield generator','shield booster','bi-weave','bi weave','prismatic','hull reinforcement','hrp','deep plating','resistance','armour','armor')) set.add('knowledge');
...
function relatedLinks(modules) {
  ...
  if (modules.has('ships') || modules.has('knowledge')) add('Ship Catalogue', '/ships/');
