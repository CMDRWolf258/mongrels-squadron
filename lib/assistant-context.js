...
const PUBLIC_KNOWLEDGE = {
  ...
  navigation: {
    carrierCoordination: {
      ...
      createPost: 'On the Carriers page, go to Carrier Coordination and choose New Coordination Post.',
      loadingEvent: 'For a carrier loading event, create a New Coordination Post and set Activity to Loading. Add commodity, target/remaining quantity, timing, purpose, and loading instructions as needed.',
    },
  },
};
...
function relatedLinks(modules, query = '') {
  ...
  if (modules.has('carriers')) { add('Carrier Coordination', '/carriers/'); add('Member Portal', '/member/'); }
