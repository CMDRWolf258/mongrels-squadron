...
const NAVIGATION_DESTINATIONS = [
  ...
  {
    id:'mongrel-pursuits', label:'Mongrel Pursuits', href:'/pursuits/',
    desktop:'Member button → Member Portal → Mongrel Pursuits', compact:'Member button → Member Portal → Mongrel Pursuits',
    action:'Use Mongrel Pursuits to choose the Elite activities you enjoy, specialize in, or want to participate in with other Mongrels. Pursuits are interests, not duties, rank, or leadership appointments, and they synchronize with the member profile and Discord Pursuit roles.',
    keywords:['mongrel pursuits','pursuits','my activities','preferred activities','activity interests','interests','change my activities','discord roles','activity roles','what i like to do'],
  },
  {
    id:'combat-escort-network', label:'Combat Escort Network', href:'/escort/',
    desktop:'Command → Combat Escort Network', compact:'MENU → Command → Combat Escort Network',
    memberPortal:'Member button → Member Portal → Combat Escort Network',
    action:'Use Combat Escort Network to request combat protection or answer another Mongrel\'s live escort call. Open requests show system, destination or area, timing, urgency, objective, notes, and synchronized responders from the website and Discord.',
    keywords:['combat escort','escort request','escort requests','combat escort network','need escort','need protection','combat protection','protect my ship','watch my six','on my way','i can help escort','answer escort'],
  },
  {
  ...
  },
  {
    ...
    desktop:'Resources → Build & Tools → Ship Catalogue', compact:'MENU → Resources → Build & Tools → Ship Catalogue',
  ...
  },
  {
    ...
    desktop:'Resources → Learn & Look Up → Engineering', compact:'MENU → Resources → Learn & Look Up → Engineering',
  ...
  },
  {
    ...
    desktop:'Resources → Learn & Look Up → Reference Database', compact:'MENU → Resources → Learn & Look Up → Reference Database',
    keywords:['reference database','reference page','exact mechanics','lookup'],
  },
  {
    id:'field-manual', label:'Mongrel Field Manual', href:'/guides/',
    desktop:'Resources → Learn & Look Up → Mongrel Field Manual', compact:'MENU → Resources → Learn & Look Up → Mongrel Field Manual',
    action:'Use the Mongrel Field Manual to learn an activity. Use its Reference Database for exact mechanics, Glossary for terminology, and Mongrel Toolbox for trusted specialist tools and apps.',
    keywords:['field manual','mongrel field manual','guides','guide index','training resources','training guide'],
  },
  {
    id:'mongrel-toolbox', label:'Mongrel Toolbox', href:'/guides/resources/',
    desktop:'Resources → Build & Tools → Mongrel Toolbox', compact:'MENU → Resources → Build & Tools → Mongrel Toolbox',
    action:'Use the Mongrel Toolbox for curated external websites, databases, companion apps, and specialist community references. Guides teach how and why; the Toolbox points to purpose-built tools.',
    keywords:['mongrel toolbox','toolbox','external tools','external resources','elite tools','companion apps','inara','edsy','spansh','edmc','eddiscovery','srv survey','srvsurvey'],
  },
  {
    id:'glossary', label:'Glossary', href:'/guides/glossary/',
    desktop:'Resources → Learn & Look Up → Glossary', compact:'MENU → Resources → Learn & Look Up → Glossary',
