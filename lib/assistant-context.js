...
function pickModules(query) {
  ...
  if (has('multiplayer','wing up','team up','team beacon','wing beacon','nav lock','nav-lock','instancing','same instance','different instance','multicrew','multi crew','telepresence','physical multicrew','physical crew','helm','gunner','fighter con','ship launched fighter','ship-launched fighter','slf crew','scorpion multicrew','team mission','wing mission','share mission','mission depot','trade dividend','shared bounty','operation runner','elite operations','operations update','merc coin','merc coins','operations matchmaking','mercenary mode','powerplay mode','mass jump','more than four commanders','more than 4 commanders')) set.add('knowledge');
