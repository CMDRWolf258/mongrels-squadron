...
const NAVIGATION_DESTINATIONS = [
  ...
  },
  {
    ...
    action:'Use New Project or Start a Post on the project board to create a project/help request. Officers can also publish official squad projects/events.',
    keywords:['projects and events','project board','new project','create project','help request','post a project','squad event','create event'],
  },
  {
