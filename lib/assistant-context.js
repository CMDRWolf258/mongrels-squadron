...
function pickModules(query) {
  ...
  if (has('bgs','background simulation','influence','inf','tick','minor faction','conflict','conflict day','best of seven','government','ethos','corporate','dictatorship','democracy','cooperative','anarchy','expansion','retreat','war','civil war','election','boom','bust','civil liberty','civil unrest','lockdown','outbreak','famine','public holiday','pirate attack','asset ownership','asset at risk','controlling faction','invasion')) set.add('knowledge');
...
function hasBgsTerms(query) {
  ...
  return ['bgs','background simulation','influence','inf','tick','minor faction','conflict','conflict day','best of seven','government','ethos','corporate','dictatorship','democracy','cooperative','anarchy','expansion','retreat','war','civil war','election','boom','bust','civil liberty','civil unrest','lockdown','outbreak','famine','public holiday','pirate attack','asset ownership','asset at risk','controlling faction','invasion'].some(x => q.includes(x));
}
