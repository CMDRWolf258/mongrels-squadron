...
- the Watch Discord preference is currently **Prepared** only. **not yet enabled:** automatic Discord watch-card creation, transition alert delivery, subscriber trigger messages, BGS enrichment, automatic best-source promotion, or MongrelScout market writes. Do not label those pieces live until they are wired and production-validated.
