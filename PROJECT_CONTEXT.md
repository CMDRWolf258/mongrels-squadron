...
- Officer Trade Control lists saved watches and supports **Load Search**, **Pause/Resume**, and **Remove**. Newly saved watches deliberately show **Pending Scheduler**; saving does not imply background evaluation is running.
