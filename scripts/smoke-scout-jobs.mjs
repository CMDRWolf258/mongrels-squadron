...
assert.match(page,/scout-jobs\.js\?v=5/);
...
assert.match(scoutPage,/scout-jobs\.js\?v=5/);
...
for(const pattern of [/loadActiveMongrelSystems/,/syncScoutDiscordAfterAction/])assert.match(jobsApi,pattern);
