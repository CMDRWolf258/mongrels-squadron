...
for(const pattern of [/Elite Connection & Scout/,/data-frontier-card-connect/,/Connect Elite Account/,/Scout & Setup/,/Read README/,/member-dashboard\.js\?v=86/])assert.match(memberPage,pattern);
