(() => {
  ...
  const nextSteps = {
    ...
    surface:{new:'Learn the Operation Runner loop, choose a manageable scenario, and prepare both the ship and on-foot side of the mission.',some:'Improve phase transitions, role coverage, scenario selection, and mixed ship/on-foot execution.',comfortable:'Take on Hard Operations deliberately, diagnose failure modes, and become reliable across specialized squad roles.',experienced:'Plan Operations sessions, assign roles and redundancy, adapt under pressure, and mentor newer operators.'},
