(() => {
  ...
  const qtyNumber = value => Number(String(value ?? '').replace(/[^0-9]/g,'')) || 0;
  const fmtQty = value => qtyNumber(value).toLocaleString();
